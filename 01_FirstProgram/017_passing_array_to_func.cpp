//In this exercise you will create a program that will be used to print the guest_list to an even and then clear the guest_list when the event is over.
//
//Begin by completing the function prototypes print_guest_listand clear_guest_list which are both passed an array of std::string and a size_t value.
//Ensure that the array cannot be modified within the print_guest_list function by using the keyword const in the parameter list.
//
//Now that the function prototypes have been declared, at the bottom of the file define both functions.
//
//Both the print_guest_listand clear_guest_list functions will be passed the array argument guest_list and the size_t argument guest_list_size which have both been provided to you.
//
...
//print_guest_list
//
//and passing the array argument guest_listand the size_t argument guest_list_size with each function call.
