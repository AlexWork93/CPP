...
//
//Both the print_guest_listand clear_guest_list functions will be passed the string arguments guest_1, guest_2, and guest_3 which have all been provided to you.
//
//The print_guest_list function should print the guest list in the order of guest_1, guest_2, guest_3, with each entry being printed on a new line.For testing purposes, 
//please ensure that a newline is printed after guest_3 either through the use of endl; or the newline character "\n".
//
